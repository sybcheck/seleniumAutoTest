...
public class FirefoxjingxiaoyuntestcaseTest extends DriverBase {

	@Test
	public void firefoxjingxiaoyuntestcase() {
		LOGGER.info("执行火狐抓取的代码");
		...
		driver.findElement(By.cssSelector(".searchtoolbar-search-div")).click();
		driver.findElement(By.cssSelector(".searchtoolbar-search-span")).click();
		{
			WebElement element = driver.findElement(By.cssSelector(".searchtoolbar-search-span"));
			Actions builder = new Actions(driver);
